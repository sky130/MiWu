...
1. **授权范围**：仅可用于指代、宣传或关联“米屋”项目本身
2. **禁止商用**：不得用于任何公司、组织或产品的商标、商号，或任何可能暗示商业授权、代言的行为
3. **使用方式**：使用时必须保持LOGO完整、清晰，不得改变颜色、形状、比例或组合方式
4. **禁止行为**：禁止用于任何违法、有害、误导性或损害项目声誉的场合
5. **最终解释**：本规则的最终解释权归项目方所有
